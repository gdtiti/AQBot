...
- **Локальная база знаний (RAG)** — Поддержка нескольких баз знаний. Загружайте документы для автоматического парсинга, разбивки на чанки и векторного индексирования (LanceDB).
