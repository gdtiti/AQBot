...
- **Base de conocimiento local (RAG)** — Soporta múltiples bases de conocimiento. Sube documentos para análisis automático, fragmentación e indexación vectorial (LanceDB).
